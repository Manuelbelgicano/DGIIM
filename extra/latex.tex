...
\lx (\LaTeX) es un sistema de composición de textos que incluye herramientas
para la creación de escritos científicos y técnicos. Además, permite al
usuario configurar la estructura del documento que escribe hasta el más
mínimo detalle. \LaTeX es una herramienta de software libre, por lo que se 
