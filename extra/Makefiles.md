...
4. Directivas y funciones
   3.1. Directivas
   3.2. Funciones
5. Otras utilidades de interés
6. Makefile de ejemplo final
7. Bibliografía y datos del autor
...
Estos apuntes están basados en el manual de la GNU de make. La función tput ha sido sacada de esta pregunta en stackoverflow. Finalmente, los makefiles de ejemplo, junto a sus archivos necesarios están alojados aquí.
